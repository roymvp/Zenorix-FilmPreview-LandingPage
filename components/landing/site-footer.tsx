 ...
 *
 * Everything that used to live here has been removed on purpose — brand block,
 * tagline, trademark disclaimer, language selector (it already exists in the top
 * bar) and the theme toggle (the app is dark-only). The page closes on the
 * install CTA, so the footer's whole job is to carry the legal minimum without
 * offering a single competing thing to click.
 */
